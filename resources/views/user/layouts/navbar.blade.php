    ...
    <div class="container-fluid">
        ...
        <div class="navbar-left">
            <div class="navbar-btn">
                <a href="/"><img src="/assets/images/logog.png" alt="Brego Logo" class="img-fluid logo"></a>
        ...
        <div class="navbar-right">
            <div id="navbar-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li><a @click="exit()" class="icon-menu"><i style="cursor: pointer" class="icon-power"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
