...
@section('content')
        ...
        <div id="mySideFilter" class="sidenav">
            ...
            <div class="mighat-box radiobutton">
                ...
                <div class="side-content">
                    <label class="container">
                        <input @click="get_product_filter_sidebar(0)" type="radio" name="radio">
                        <span class="checkmark"></span>
                        همه
                    </label>
                    <label class="container">
                        <input @click="get_product_filter_sidebar(1)" type="radio" name="radio">
                        <span class="checkmark"></span>
                        رایگان
                    </label>
                    <label class="container">
                        <input @click="get_product_filter_sidebar(2)" type="radio" name="radio">
                        <span class="checkmark"></span>
                        غیر رایگان
                    </label>
            ...
            <div class="mighat-box radiobutton">
                ...
                <div class="side-content">
                    <label class="container">
                        <input @click="get_product_filter_sidebar(3)" type="radio" name="radio">
                        <span class="checkmark"></span>
                        آفلاین
                    </label>

                    <label class="container">
                        <input @click="get_product_filter_sidebar(4)" type="radio" checked="checked" name="radio">
                        <span class="checkmark"></span>
                        آنلاین
                    </label>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="search_product">
                        ...
                        <input v-model="product_refahi_search" type="text" placeholder="چی دوست داری یاد بگیری؟ :)">
                ...
                <div class="row">
                    <div class="col-12 col-xl-3">
                        ...
                        <div class="mighat-box radiobutton desktop-box">
                            ...
                            <div class="side-content">
                                <label class="container">
                                    <input @click="get_product_filter_sidebar(0)" type="radio"
                                           name="radio">
                                    <span class="checkmark"></span>
                                    همه
                                </label>
                        ...
                        <div class="mighat-box radiobutton desktop-box">
                            ...
                            <div class="side-content">
                                ...
                                <label class="container">
                                    <input @click="get_product_filter_sidebar(4)" type="radio"
                                           name="radio">
                                    <span class="checkmark"></span>
                                    آنلاین
                                </label>
                            ...
                            <div class="col-md-12">
                                <div class="main_content_left_top_title">
                                    ...
                                    <div class="mighat-types">
                                        ...
                                        <button @click="get_product_filter(0)"
                                                :class="[isActive_product == 0 ? 'active' : '']">جدیدترین

                                        </button>
                                        <button @click="get_product_filter(1)"
