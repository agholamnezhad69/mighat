    ...
    <div class="container-fluid">
        ...
        <div class="navbar-left">
            <div class="navbar-btn">
                <a href="index.html"><img src="/assets/images/logog.png" alt="Brego Logo" class="img-fluid logo"></a>
...
<!--                    <li><a href="page-social.html" class="social icon-menu" title="News">اجتماعی</a></li>
                    ...
                    <li><a @click="exit_admin()"  class="icon-menu"><i style="cursor: pointer" class="icon-power"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
