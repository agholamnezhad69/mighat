...
export default {
    extends: Pie,
    props: ['optionschart_noe_daneshkah'],
    methods: {
        getRandomInt() {
        ...
        setOption() {
            ...
            this.renderChart({
                    ...
                    labels: ['آزاد اسلامی', 'دولتی', 'پیام نور', 'غیر انتفاعی', 'نظامی و انتظامی', 'فرهنگیان', 'علمی-کاربردی'],
                    datasets: [
                        {
                            label: 'تعداد',
                            ...
                            data: this.optionschart_noe_daneshkah
                        },
                    ],
