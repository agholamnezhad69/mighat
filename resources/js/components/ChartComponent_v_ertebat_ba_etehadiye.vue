...
export default {
    extends: Pie,
    props: ['optionschart_v_ertebat_ba_etehadiye'],
    methods: {
        getRandomInt() {
        ...
        setOption() {
            ...
            this.renderChart({
                    ...
                    labels: ['ارتباطم قطع شده',
                        'کم و بیش ارتباط دارم',
                        'دورا دور اخبار رو پیگیری میکنم',
                        'ارتباط مستمر دارم'],
                    datasets: [
                        {
                            label: 'تعداد',
                            ...
                            data: this.optionschart_v_ertebat_ba_etehadiye
                        },
                    ],
